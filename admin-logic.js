...
async function generateSlideDefinitions() {
    if (typeof supabase === 'undefined') {
        document.getElementById("diapo-content").innerHTML = `<div class="slide-item"><h1>ERREUR: Client Supabase non chargé. Vérifiez supabase-config.js.</h1></div>`;
        return;
    }
...
// Le démarrage utilise defer, donc l'appel simple est suffisant
initializeAdmin();
